...
var BASE_PACKAGE = {
  description: 'A full Kryfios node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-kryfios': '/opt/kryfios/insight/bitcore-lib-kryfios',
    'bitcore-node-kryfios': '/opt/kryfios/insight/bitcore-node-kryfios'
  }
};
