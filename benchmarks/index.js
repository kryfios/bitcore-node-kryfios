...
console.log('Kryfios Service native interface vs. Kryfios JSON RPC interface');
console.log('----------------------------------------------------------------------');
...
var bitcoind = require('../').services.Bitcoin({
  node: {
    datadir: process.env.HOME + '/.kryfios',
    network: {
      name: 'testnet'
    }
  }
...
bitcoind.start(function(err) {
  ...
  console.log('Kryfios started');
});

bitcoind.on('ready', function() {

  console.log('Kryfios ready');
